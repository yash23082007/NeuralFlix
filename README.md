...
NeuralFlix is built on a foundation of transparency and user agency. Instead of opaque, uncalibrated black-box models that optimize for engagement, NeuralFlix relies on a **Deterministic Explainable Scorer** (our V0 Ranker).
...
- **Engine**: The "Taste Constellation" deterministic scorer provides transparent, user-steerable, and per-feature attributable movie recommendations.
...
### Taste Constellation Deterministic Scorer
...
| `GET`  | `/api/v1/users/me/profile` | Returns the sequenced Taste DNA profile based on real interactions. |
| `PUT`  | `/api/v1/users/me/taste-controls` | Updates the Taste Constellation preferences in real-time. |
